...
5. Immediately transition into [$follow-the-pr](/Users/billeaston/.claude/skills/follow-the-pr/SKILL.md) and keep looping on feedback, CI, and review until the PR is merged or explicitly paused.
...
After the PR is up, immediately switch into [$follow-the-pr](/Users/billeaston/.claude/skills/follow-the-pr/SKILL.md).
